"""OmegaConf -> native (SimpleNamespace/list) conversion.

Lives in core so components can normalize configs without depending on app;
app/config.py re-exports it as the wiring-boundary entry point.
"""
